...
if (!isset($_SESSION["logged_in"]) || $_SESSION["logged_in"] !== true) {
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        $connection->addContacts($data->getContactData(), $_SESSION["id"]);
        header("location: ./contacts.php");
        // When the user submits this page, a modular box should appear asking if they would like to add another contact
    }
}
